...
def main():
    ...
    while not glfw.window_should_close(window):
        ...
        rot_z = glm.rotate(glm.mat4(1.0), 0.5 * glfw.get_time(), glm.vec3(0.0, 0.0, 1.0))

        transformLoc = glGetUniformLocation(shader, "transform")
        glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm.value_ptr(pers*trans*rot_x*rot_y*rot_z))
